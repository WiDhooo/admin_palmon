                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Formulir Edit data artikel</li>
                        </ol>
                        

                        <div class="card mb-4">
                        <form action="{{ url('http://127.0.0.1:8001/api/artikel/' . $hasil_query['id']) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($hasil_query['gambar']) && !empty($hasil_query['gambar']))
                                            <img src="{{ url('gambars/' . $hasil_query['gambar']) }}" alt="Foto Artikel" class="rounded" style="width: 100%; max-width: 100px; height: auto;">
                                        @else
